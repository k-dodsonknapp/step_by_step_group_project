...
def seed_supplies():
    ...
    db.session.add(gummy_bear1)
    db.session.add(gummy_bear2)
    db.session.add(gummy_bear3)
    db.session.add(gummy_bear4)
    db.session.add(gummy_bear5)
    db.session.add(gummy_bear6)
    db.session.add(gummy_bear7)
    db.session.add(gummy_bear8)
    db.session.add(gummy_bear9)
    db.session.add(gummy_bear10)
    db.session.add(gummy_bear11)
    db.session.add(gummy_bear12)
    db.session.add(gummy_bear13)
    db.session.add(gummy_bear14)
    ...
    db.session.add(fortune_cookie10)
    ...
    db.session.add(rc_airplane10)
    db.session.add(rc_airplane11)
    db.session.add(rc_airplane12)
    db.session.add(rc_airplane13)
    db.session.add(rc_airplane14)
    db.session.add(rc_airplane15)
